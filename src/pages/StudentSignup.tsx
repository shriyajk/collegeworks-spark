      ...
      <div className="flex flex-1 items-start justify-center px-4 py-8">
        <div className="w-full max-w-lg space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-8" noValidate>
            ...
            <fieldset className="border-0 p-0 m-0">
              <Card className="p-6 border-2 hover:border-primary/20 transition-colors">
                <legend className="sr-only">Student Verification</legend>
                <h2 className="text-lg font-semibold mb-4 text-foreground flex items-center gap-2">
            ...
            <div className="pt-4">
              <Button 
                type="submit" 
                className="w-full h-14 text-lg font-semibold bg-primary hover:bg-primary/90 focus:ring-4 focus:ring-primary/20 transition-all"
                size="lg"
              >
                Create Account
              </Button>
